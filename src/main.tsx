...
function Trang() {
  ...
  return (
    <>
      ...
      <a
        href="#dau-trang"
        className="sr-only focus:not-sr-only focus:absolute focus:top-2 focus:left-2 focus:z-60 focus:bg-muc focus:px-3 focus:py-2 focus:text-giay-noi"
      >
      ...
      <main>
        ...
        <KhungMuc ma="nang-luc" tieu_de={NHAN.muc_nang_luc}>
      ...
      <footer className="border-t border-duong">
        <div className="mx-auto max-w-[76rem] px-5 py-8 text-[0.82rem] text-muc-mo sm:px-8">
          {chu(NHAN.chan_trang)}
        </div>
      </footer>
    </>
